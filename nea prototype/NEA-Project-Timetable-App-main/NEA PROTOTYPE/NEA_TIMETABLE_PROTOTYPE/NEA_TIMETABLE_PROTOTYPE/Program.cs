...
";
        ...
        static void TableDisplay(string block,int day)
        {
            string tableM = "";
            if(day == 0)
            {
            ...
            Console.WriteLine(tableM);

            string tableTu = "";
            if (day == 1)
            {
                tableTu = tableTu + block;
                block = "";
            }
            Console.WriteLine(tableTu);
            ...
            Console.WriteLine(tableW);

            string tableTh = ""; 
            if (day == 3)
            {
                tableTh = tableTh + block;
                block = "";
            }
            Console.WriteLine(tableTh);
            ...
            Console.WriteLine(tableF);

            string tableSa = ""; 
            if (day == 5)
            {
                tableSa = tableSa + block;
                block = "";
            }
            Console.WriteLine(tableSa);

            string tableSu = "";
            if (day == 6)
            {
                tableSu = tableSu + block;
                block = "";
            }
            Console.WriteLine(tableSu);
